...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" data-spy="affix" data-offset-top="0">
    <div class="container">
        ...
        <div class="nav-item" style="margin-right: 0;">
            <a class="- btn btn-primary rounded ml-4" style="width: 110px;" href="components.html">Connexion</a>
            <a class="- btn btn-primary rounded ml-4" style="width: 110px;" href="components.html">inscrire</a>
...
<div class="container_login" id="container">
    ...
    <div class="form-container sign-in-container">
        <form action="Sinscrire" method="post">
            <h1 id="sing_txt">S'inscrire</h1>

            <span>ou utilisez votre compte</span>
            <input type="text" placeholder="votre nom" name="Username" />
            <input type="email" placeholder="Email" name="email" />
            <input type="password" placeholder="password" name="password" />
            <input type="password" placeholder="comfirmer Password" name="confirmpass" />
...
<footer class="page-footer">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <p>Copyright <script>document.write(new Date().getFullYear())</script> &copy; <a href="https://github.com/Kaiji21/Lp_JEE_MiniProject" target="_blank">HAKIM & RIDA</a></p>
            </div>
            <div class="col-sm-6">
                <div class="socials">
